...
class ApisearchServerExtension extends BaseExtension
{
    ...
    {
        return [
            'apisearch_server.middleware_domain_events_service' => $_SERVER['APISEARCH_EVENTS_MIDDLEWARE'] ?? $config['middleware_domain_events_service'],
            ...
            'apisearch_server.god_token' => $_SERVER['APISEARCH_GOD_TOKEN'] ?? $config['god_token'],
            'apisearch_server.readonly_token' => $_SERVER['APISEARCH_READONLY_TOKEN'] ?? $config['readonly_token'],
            'apisearch_server.ping_token' => $_SERVER['APISEARCH_PING_TOKEN'] ?? $config['ping_token'],
        ];
    }
